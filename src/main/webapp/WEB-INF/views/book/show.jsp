		...
		<div class="row">
			...
			<table class="table table-striped">
			  ...
			  <tr>
			    ...
			    <td>
			      <fmt:formatNumber value="${book.price}" pattern="###,###"/>円<%-- <c:out value="${book.price}" />円 --%>
			    </td>
			  </tr>
			  <tr>
			    <th>
			  ...
			  <tr>
			    ...
			    <td>
			      <fmt:formatDate value="${book.saledate}" pattern="yyyy年MM月dd日"/><%-- <c:out value="${book.saledate}"/> --%>
			    </td>
			  </tr>
			  <tr>
			    <th>
			...
			</table><a href="${pageContext.request.contextPath}/book/list">戻る</a>
